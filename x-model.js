...
export class XModel {
   ...
   */
  static register() {
    throw new Error('The "register" method is no longer needed. You may safely delete this call.');
  }
   ...
   * 
   * @param {undefined|string|number|(string|number)[]} [path]
   * @returns {boolean}
   */
  has(path) {
